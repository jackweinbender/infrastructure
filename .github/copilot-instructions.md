...
metadata:
  annotations:
    ...
    "k8s-secret-sync.weinbender.io/provider-ref": "op://vault/item/field"
```
...
metadata:
  ...
  annotations:
    "k8s-secret-sync.weinbender.io/provider-name": "op"
    "k8s-secret-sync.weinbender.io/secret-key": "password"
    "k8s-secret-sync.weinbender.io/provider-ref": "op://microk8s/app-db/password"
---
...
metadata:
  annotations:
    ...
    "k8s-secret-sync.weinbender.io/provider-name-name": "op"
    "k8s-secret-sync.weinbender.io/provider-name-ref": "op://vault/item/field"
    "k8s-secret-sync.weinbender.io/secret-key": "password"
```
